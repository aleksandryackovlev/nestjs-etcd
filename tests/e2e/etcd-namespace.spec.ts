...
import { ApplicationModule } from '../src/app-namespace.module';
...
describe('Etcd', () => {
  ...
  it('should create records in the given namespace', async () => {
    ...
    await request(server)
      .get('/feature/client2/client1-client1_feature_key')
      .expect(200, { key: 'client1-client1_feature_key', value: 'client1_feture_value' });
  });
